...
type AnalysisServiceClient interface {
	AnalyzeData(ctx context.Context, in *MarketDataRequest, opts ...grpc.CallOption) (*AnalysisResponse, error)
}
...
func (c *analysisServiceClient) AnalyzeData(ctx context.Context, in *MarketDataRequest, opts ...grpc.CallOption) (*AnalysisResponse, error) {
...
type AnalysisServiceServer interface {
	AnalyzeData(context.Context, *MarketDataRequest) (*AnalysisResponse, error)
...
func (UnimplementedAnalysisServiceServer) AnalyzeData(context.Context, *MarketDataRequest) (*AnalysisResponse, error) {
...
func _AnalysisService_AnalyzeData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalysisServiceServer).AnalyzeData(ctx, req.(*MarketDataRequest))
	}
